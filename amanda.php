...
<div class="card  mx-2 shadow p-0 mb-5 bg-light rounded">
    ...
    <p class="card-text">I’ve held a number of different jobs since beginning my college career.
...
<div class="card  mx-2 shadow p-0 mb-5 bg-light rounded">
    ...
    <p class="card-text">In addition to my academic and curricular pursuits, I have a number of hobbies.
