...
<header>
    <nav class="container pt-3">
        <ul class="nav nav-pills float-right">
            ...
            <li class="nav-item"><a class="nav-link text-white bg-dark" href="amanda.php">Amanda O'Donnell</a></li>
...
<div class="card  mx-2 shadow p-0 mb-5 bg-light rounded">
    <div class="row no-gutters">
        <div class="col-md-3">
            <img src="images/amanda.jpg" class="card-img" alt="Photo of Amanda">
        </div>
        <div class="col-md-8">
            <div class="card-body">
...
<div class="card  mx-2 shadow p-0 mb-5 bg-light rounded row">
    <div class="card-body">
        ...
        <p class="card-text col-md-10">I’ve held a number of different jobs since beginning my college career.
...
<div class="card  mx-2 shadow p-0 mb-5 bg-light rounded">
    <div class="card-body">
        ...
        <p class="card-text col-md-10">In addition to my academic and curricular pursuits, I have a number of hobbies.
